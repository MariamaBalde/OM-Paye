        ...
        if ($compte1) {
            ...
            if ($compte2) {
                \App\Models\Transaction::create([
                    ...
                    'code_verifie' => true,
                    'reference' => 'TXN' . date('Ymd') . '001', // AJOUTÉ
                    'description' => 'Transfert vers Fatou Sarr', // AJOUTÉ
                ]);
            }
            ...
            if ($marchand1) {
                \App\Models\Transaction::create([
                    ...
                    'code_verifie' => true,
                    'reference' => 'TXN' . date('Ymd') . '002', // AJOUTÉ
                    'description' => 'Paiement marchand Orange', // AJOUTÉ
                ]);
            }
            ...
            \App\Models\Transaction::create([
                ...
                'code_verifie' => true,
                'reference' => 'TXN' . date('Ymd') . '003', // AJOUTÉ
                'description' => 'Dépôt d\'argent', // AJOUTÉ
            ]);
            ...
            if ($compte3) {
                \App\Models\Transaction::create([
                    ...
                    'code_verifie' => false,
                    'reference' => 'TXN' . date('Ymd') . '004', // AJOUTÉ
                    'description' => 'Transfert en attente', // AJOUTÉ
                ]);
            }
            ...
            \App\Models\Transaction::create([
                ...
                'statut' => 'echouee',
                'reference' => 'TXN' . date('Ymd') . '005', // AJOUTÉ
                'description' => 'Retrait échoué', // AJOUTÉ
            ]);
        }
    }
}
